...
public class ObjectPoolManager : Singleton<ObjectPoolManager>
{
    ...
    public void CheckAlreadyExist(string key,GameObject prefab)
    {
        if(!dicPool.ContainsKey(key))
        {
            var objectData = AddNewObject(prefab,key);
            Register(objectData);
        }
    }
    
    private PoolObjectData AddNewObject(GameObject prefab,string key)
    {
